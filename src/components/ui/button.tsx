  ...
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        "level-easy": "bg-level-easy text-white shadow-xs hover:bg-level-easy/80",
        "level-normal": "bg-level-normal text-white shadow-xs hover:bg-level-normal/80",
        "level-hard": "bg-level-hard text-white shadow-xs hover:bg-level-hard/80",
        "level-expert": "bg-level-expert text-white shadow-xs hover:bg-level-expert/80",
        "level-master": "bg-level-master text-white shadow-xs hover:bg-level-master/80",
        "level-ultra": "bg-level-ultra text-white shadow-xs hover:bg-level-ultra/80",
        "outline-level-easy": "border border-level-easy text-level-easy shadow-xs hover:bg-level-easy/20",
        "outline-level-normal": "border border-level-normal text-level-normal shadow-xs hover:bg-level-normal/20",
        "outline-level-hard": "border border-level-hard text-level-hard shadow-xs hover:bg-level-hard/20",
        "outline-level-expert": "border border-level-expert text-level-expert shadow-xs hover:bg-level-expert/20",
        "outline-level-master": "border border-level-master text-level-master shadow-xs hover:bg-level-master/20",
        "outline-level-ultra": "border border-level-ultra text-level-ultra shadow-xs hover:bg-level-ultra/20",
      },
      size: {
