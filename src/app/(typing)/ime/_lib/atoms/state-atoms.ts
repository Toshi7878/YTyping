...
const textareaPlaceholderTypeAtom = focusAtom(gameStateUtilParamsAtom, (optic) => optic.prop("textareaPlaceholderType"))
...
const updateResultsAtom = atom(null, (_get, set, updateResult: { index: number; result: WordResults[number] }) => {
...
const writeImeTypeOptionsAtom = atom(
  null,
  (_get, set, newOptions: Partial<ExtractAtomValue<typeof imeTypeOptionsAtom>>) => {
