import { useLineCount, usePlayer, useProgress, useReadYTStatus, useResultCards } from "../../atoms/ref-atoms"
...
import { useGetSeekLineCount } from "./timer/get-line-count-by-time"
...
export const useMoveLine = () => {
  ...
  const moveNextLine = () => {
    ...
    const prevLineTime = (nextCount > 1 ? map.mapData[nextCount].time - map.mapData[nextCount - 1].time : 0) / playSpeed
