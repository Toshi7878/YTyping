import {
  ...
  useProgress,
  useYTStatus,
} from "@/app/(typing)/type/atoms/refAtoms";
import { usePlaySpeedStateRef } from "@/app/(typing)/type/atoms/speedReducerAtoms";
import {
  useReadCurrentTime,
...
import { useDisplaySkipGuide } from "@/app/(typing)/type/hooks/playing-hooks/timer-hooks/displaySkipGuide";
