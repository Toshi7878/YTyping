...
import { ClearRateText } from "@/shared/text/clear-rate-text";
import { DateDistanceText } from "@/shared/text/date-distance-text";
import { InputModeText } from "@/shared/text/input-mode-text";
import { ResultToolTipText } from "@/shared/text/result-tooltip-text";
