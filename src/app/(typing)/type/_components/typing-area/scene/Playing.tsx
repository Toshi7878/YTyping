import { useReadMapState, useSceneState, useSetNextLyrics } from "@/app/(typing)/type/atoms/stateAtoms";
import { useEffect } from "react";
import PlayingCenter from "./playing-child/PlayingCenter";

import { useGameUtilityReferenceParams, useLineCount, useUserStats } from "@/app/(typing)/type/atoms/refAtoms";
import { useHandleKeydown } from "@/app/(typing)/type/hooks/playing-hooks/keydown-hooks/playingKeydown";
import { useTimerControls } from "@/app/(typing)/type/hooks/playing-hooks/timer-hooks/timer";
